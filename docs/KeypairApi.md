...
[**list_supported_key_pair_types**](KeypairApi.md#list_supported_key_pair_types) | **GET** /core/supported-keypairs | List supported key pair types
...
# **list_supported_key_pair_types**
> SupportedKeypairPublicKeyTypesResponse list_supported_key_pair_types()
...
with hyperstack.ApiClient(configuration) as api_client:
    ...
    try:
        # List supported key pair types
        api_response = api_instance.list_supported_key_pair_types()
        print("The response of KeypairApi->list_supported_key_pair_types:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling KeypairApi->list_supported_key_pair_types: %s\n" % e)
```
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Retrieval of supported key pair types successful. |  -  |
**500** | Internal Server Error |  -  |
