...
------------- | ------------- | -------------
[**create_custom_image**](SnapshotsApi.md#create_custom_image) | **POST** /core/snapshots/{snapshot_id}/image | Create an image from a snapshot
...
[**list_snapshots**](SnapshotsApi.md#list_snapshots) | **GET** /core/snapshots | Retrieve list of snapshots with pagination
[**restore_snapshot**](SnapshotsApi.md#restore_snapshot) | **POST** /core/snapshots/{id}/restore | Restore a snapshot


# **create_custom_image**
> CreateImage create_custom_image(snapshot_id, payload)
...
with hyperstack.ApiClient(configuration) as api_client:
    ...
    try:
        # Create an image from a snapshot
        api_response = api_instance.create_custom_image(snapshot_id, payload)
        print("The response of SnapshotsApi->create_custom_image:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SnapshotsApi->create_custom_image: %s\n" % e)
```
...
# **list_snapshots**
> Snapshots list_snapshots(page=page, page_size=page_size, search=search)
...
with hyperstack.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve list of snapshots with pagination
        api_response = api_instance.list_snapshots(page=page, page_size=page_size, search=search)
...
# **restore_snapshot**
> Instance restore_snapshot(id, payload)
...
with hyperstack.ApiClient(configuration) as api_client:
    ...
    try:
        # Restore a snapshot
        api_response = api_instance.restore_snapshot(id, payload)
        print("The response of SnapshotsApi->restore_snapshot:\n")
        pprint(api_response)
    except Exception as e:
