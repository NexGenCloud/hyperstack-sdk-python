...
[**request_vm_console**](VncUrlApi.md#request_vm_console) | **GET** /core/virtual-machines/{vm_id}/request-console | Request Instance Console
...
# **request_vm_console**
> RequestConsole request_vm_console(vm_id)
...
with hyperstack.ApiClient(configuration) as api_client:
    ...
    try:
        # Request Instance Console
        api_response = api_instance.request_vm_console(vm_id)
        print("The response of VncUrlApi->request_vm_console:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VncUrlApi->request_vm_console: %s\n" % e)
```
