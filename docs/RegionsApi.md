# hyperstack.RegionsApi

All URIs are relative to *https://infrahub-api.nexgencloud.com/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**list_regions_endpoint**](RegionsApi.md#list_regions_endpoint) | **GET** /object-storage/regions | Get a list of supported regions


# **list_regions_endpoint**
