...
------------- | ------------- | -------------
[**get_contract_gpu_allocation_graph**](CustomerContractApi.md#get_contract_gpu_allocation_graph) | **GET** /pricebook/contracts/{contract_id}/gpu_allocation_graph | Retrieve GPU Allocation Graph for Contract
[**list_customer_contracts**](CustomerContractApi.md#list_customer_contracts) | **GET** /pricebook/contracts | List Contracts
[**retrieve_contract**](CustomerContractApi.md#retrieve_contract) | **GET** /pricebook/contracts/{contract_id} | Retrieve Contract Details


# **get_contract_gpu_allocation_graph**
> ContractGPUAllocationGraphResponse get_contract_gpu_allocation_graph(contract_id, start_date=start_date, end_date=end_date)
...
with hyperstack.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve GPU Allocation Graph for Contract
        api_response = api_instance.get_contract_gpu_allocation_graph(contract_id, start_date=start_date, end_date=end_date)
        print("The response of CustomerContractApi->get_contract_gpu_allocation_graph:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CustomerContractApi->get_contract_gpu_allocation_graph: %s\n" % e)
```
...
> GetCustomerContractsListResponseModel list_customer_contracts(page=page, per_page=per_page)
...
with hyperstack.ApiClient(configuration) as api_client:
    ...
    try:
        # List Contracts
        api_response = api_instance.list_customer_contracts(page=page, per_page=per_page)
        print("The response of CustomerContractApi->list_customer_contracts:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CustomerContractApi->list_customer_contracts: %s\n" % e)
```
...
# **retrieve_contract**
> CustomerContractDetailResponseModel retrieve_contract(contract_id)
...
with hyperstack.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve Contract Details
        api_response = api_instance.retrieve_contract(contract_id)
        print("The response of CustomerContractApi->retrieve_contract:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CustomerContractApi->retrieve_contract: %s\n" % e)
```
