...
[**get_allowed_country_codes**](UserApi.md#get_allowed_country_codes) | **GET** /billing/user/countries | GET: Retrieve allowed country codes
...
> AllowedCountriesResponse get_allowed_country_codes()
...
with hyperstack.ApiClient(configuration) as api_client:
    ...
    try:
        # GET: Retrieve allowed country codes
        api_response = api_instance.get_allowed_country_codes()
        print("The response of UserApi->get_allowed_country_codes:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UserApi->get_allowed_country_codes: %s\n" % e)
```
