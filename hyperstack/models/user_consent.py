...
class UserConsent(BaseModel):
    ...
    consent_method: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["action", "consent_method", "consent_type", "created_at", "id", "ip_address", "org_id", "updated_at", "user_id"]
