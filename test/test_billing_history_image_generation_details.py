...
class TestBillingHistoryImageGenerationDetails(unittest.TestCase):
    """BillingHistoryImageGenerationDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillingHistoryImageGenerationDetails:
        """Test BillingHistoryImageGenerationDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillingHistoryImageGenerationDetails`
        """
        model = BillingHistoryImageGenerationDetails()
        if include_optional:
            return BillingHistoryImageGenerationDetails(
                billing_history = [
    ...
    def testBillingHistoryImageGenerationDetails(self):
        """Test BillingHistoryImageGenerationDetails"""
